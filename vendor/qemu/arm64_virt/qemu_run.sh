...
qemu_option_add "-vnc :20 -device virtio-gpu-gl,xres=486,yres=864"
#qemu_option_add "-vnc :20 -device virtio-gpu,xres=486,yres=864,addr=08.0"
...
qemu_option_add "-k en-us -display sdl,gl=on"
