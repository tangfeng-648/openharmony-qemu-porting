...
/* Limit the number of resolutions to no more than 20, otherwise the display window manager packet sent to the client will fail. */
#define DM_SUPPORT_RESOLUTIONS 20
