...
static inline void typec_altmode_set_drvdata(struct typec_altmode *altmode, void *data)
{
...
int typec_altmode_vdm(struct typec_altmode *altmode, const u32 header, const u32 *vdo, int count);
int typec_altmode_notify(struct typec_altmode *altmode, unsigned long conf, void *data);
const struct typec_altmode *typec_altmode_get_partner(struct typec_altmode *altmode);
...
struct typec_altmode *typec_altmode_get_plug(struct typec_altmode *altmode, enum typec_plug_index index);
 ...
 */
static inline enum typec_orientation typec_altmode_get_orientation(struct typec_altmode *altmode)
{
...
#define to_altmode_driver(d) container_of(d, struct typec_altmode_driver, driver)
 ...
 * handle all SVID specific communication.
 */
#define typec_altmode_register_driver(drv) __typec_altmode_register_driver(drv, THIS_MODULE)
int __typec_altmode_register_driver(struct typec_altmode_driver *drv, struct module *module);
/**
...
#define module_typec_altmode_driver(__typec_altmode_driver)                                                            \
    module_driver(__typec_altmode_driver, typec_altmode_register_driver, typec_altmode_unregister_driver)
