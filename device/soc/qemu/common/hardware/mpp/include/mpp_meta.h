...
#define FOURCC_META(a, b, c, d)                                                                                        \
    (((unsigned int)(a) << 24) | ((unsigned int)(b) << 16) | ((unsigned int)(c) << 8) | ((unsigned int)(d) << 0))
...
signed int mpp_meta_size(MppMeta meta);

MPP_RET mpp_meta_set_s32(MppMeta meta, MppMetaKey key, signed int val);
...
MPP_RET mpp_meta_get_s32(MppMeta meta, MppMetaKey key, signed int *val);
