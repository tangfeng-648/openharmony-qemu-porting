...
typedef struct MppFrameRational {
    signed int num; ///< Numerator
    signed int den; ///< Denominator
} MppFrameRational;
...
typedef struct MppFrameContentLightMetadata {
    unsigned short MaxCLL;
    unsigned short MaxFALL;
 ...
 *
 */
unsigned int mpp_frame_get_width(const MppFrame frame);
void mpp_frame_set_width(MppFrame frame, unsigned int width);
unsigned int mpp_frame_get_height(const MppFrame frame);
void mpp_frame_set_height(MppFrame frame, unsigned int height);
unsigned int mpp_frame_get_hor_stride(const MppFrame frame);
void mpp_frame_set_hor_stride(MppFrame frame, unsigned int hor_stride);
unsigned int mpp_frame_get_ver_stride(const MppFrame frame);
void mpp_frame_set_ver_stride(MppFrame frame, unsigned int ver_stride);
void mpp_frame_set_hor_stride_pixel(MppFrame frame, unsigned int hor_stride_pixel);
unsigned int mpp_frame_get_hor_stride_pixel(const MppFrame frame);

unsigned int mpp_frame_get_offset_x(const MppFrame frame);
void mpp_frame_set_offset_x(MppFrame frame, unsigned int offset_x);
unsigned int mpp_frame_get_offset_y(const MppFrame frame);
void mpp_frame_set_offset_y(MppFrame frame, unsigned int offset_y);
unsigned int mpp_frame_get_mode(const MppFrame frame);
void mpp_frame_set_mode(MppFrame frame, unsigned int mode);
unsigned int mpp_frame_get_discard(const MppFrame frame);
void mpp_frame_set_discard(MppFrame frame, unsigned int discard);
unsigned int mpp_frame_get_viewid(const MppFrame frame);
void mpp_frame_set_viewid(MppFrame frame, unsigned int viewid);
unsigned int mpp_frame_get_poc(const MppFrame frame);
void mpp_frame_set_poc(MppFrame frame, unsigned int poc);
...
unsigned int mpp_frame_get_errinfo(const MppFrame frame);
void mpp_frame_set_errinfo(MppFrame frame, unsigned int errinfo);
 ...
 */
unsigned int mpp_frame_get_eos(const MppFrame frame);
void mpp_frame_set_eos(MppFrame frame, unsigned int eos);
unsigned int mpp_frame_get_info_change(const MppFrame frame);
void mpp_frame_set_info_change(MppFrame frame, unsigned int info_change);
 ...
 * meta data parameter
 */
signed int mpp_frame_has_meta(const MppFrame frame);
