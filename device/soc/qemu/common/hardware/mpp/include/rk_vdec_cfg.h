...
MPP_RET mpp_dec_cfg_set_s32(MppDecCfg cfg, const char *name, signed int val);
MPP_RET mpp_dec_cfg_set_u32(MppDecCfg cfg, const char *name, unsigned int val);
...
MPP_RET mpp_dec_cfg_get_s32(MppDecCfg cfg, const char *name, signed int *val);
MPP_RET mpp_dec_cfg_get_u32(MppDecCfg cfg, const char *name, unsigned int *val);
