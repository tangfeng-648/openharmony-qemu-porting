...
static unsigned long clk_dclk_recalc_rate(struct clk_hw *hw, unsigned long parent_rate)
{
...
static long clk_dclk_round_rate(struct clk_hw *hw, unsigned long rate, unsigned long *prate)
{
    struct clk_divider *divider = to_clk_divider(hw);
...
static int clk_dclk_set_rate(struct clk_hw *hw, unsigned long rate, unsigned long parent_rate)
{
    struct clk_divider *divider = to_clk_divider(hw);
    unsigned int value;
                                              ...
                                              spinlock_t *lock)
{
    ...
    clk = clk_register_composite(NULL, name, parent_names, num_parents, mux ? &mux->hw : NULL, mux_ops,
