 ...
 *
 */
#ifndef H_ROCKCHIP_MPP_DEBUG_H
#define H_ROCKCHIP_MPP_DEBUG_H
...
#define mpp_debug_unlikely(type) (unlikely(mpp_dev_debug & (type)))
...
#define mpp_err(fmt, args...) pr_err("%s:%d: " fmt, __func__, __LINE__, ##args)
