...
#ifndef BIFROST_DEBUG_BACKEND_MALI_KBASE_DEBUG_KTRACE_CODES_CSF_H
#define BIFROST_DEBUG_BACKEND_MALI_KBASE_DEBUG_KTRACE_CODES_CSF_H
/*
 * Generic CSF events
 */
KBASE_KTRACE_CODE_MAKE_CODE(EVICT_CTX_SLOTS),
     ...
     */
    KBASE_KTRACE_CODE_MAKE_CODE(FIRMWARE_BOOT), KBASE_KTRACE_CODE_MAKE_CODE(FIRMWARE_REBOOT),
    KBASE_KTRACE_CODE_MAKE_CODE(SCHEDULER_TOCK), KBASE_KTRACE_CODE_MAKE_CODE(SCHEDULER_TICK),
    KBASE_KTRACE_CODE_MAKE_CODE(SCHEDULER_RESET), KBASE_KTRACE_CODE_MAKE_CODE(SCHEDULER_EXIT_PROTM),
    ...
    /* info_val == CSG_REQ ^ CSG_ACK */
    KBASE_KTRACE_CODE_MAKE_CODE(CSG_IDLE_INTERRUPT), KBASE_KTRACE_CODE_MAKE_CODE(GROUP_SYNC_UPDATE_DONE),
     ...
     */
    KBASE_KTRACE_CODE_MAKE_CODE(GROUP_EVICT_SCHED), KBASE_KTRACE_CODE_MAKE_CODE(SCHEDULER_ENTER_PROTM),
    ...
    KBASE_KTRACE_CODE_MAKE_CODE(CSI_STOP), KBASE_KTRACE_CODE_MAKE_CODE(CSI_STOP_REQUESTED),
