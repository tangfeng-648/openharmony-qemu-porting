...
#define GPU_ID2_PRODUCT_MAKE(arch_major, arch_minor, arch_rev, product_major)                                          \
    ((((u32)(arch_major)) << GPU_ID2_ARCH_MAJOR_SHIFT) | (((u32)(arch_minor)) << GPU_ID2_ARCH_MINOR_SHIFT) |           \
     (((u32)(arch_rev)) << GPU_ID2_ARCH_REV_SHIFT) | (((u32)(product_major)) << GPU_ID2_PRODUCT_MAJOR_SHIFT))
...
#define GPU_ID2_MODEL_MAKE(arch_major, product_major)                                                                  \
    ((((u32)(arch_major)) << GPU_ID2_ARCH_MAJOR_SHIFT) | (((u32)(product_major)) << GPU_ID2_PRODUCT_MAJOR_SHIFT))
...
#define GPU_ID2_MODEL_MATCH_VALUE(product_id)                                                                          \
    ((((u32)(product_id)) << GPU_ID2_PRODUCT_MAJOR_SHIFT) & GPU_ID2_PRODUCT_MODEL)
...
#define GPU_ID_MAKE(id, major, minor, status)                                                                          \
    ((((u32)(id)) << GPU_ID_VERSION_PRODUCT_ID_SHIFT) | (((u32)(major)) << GPU_ID_VERSION_MAJOR_SHIFT) |               \
     (((u32)(minor)) << GPU_ID_VERSION_MINOR_SHIFT) | (((u32)(status)) << GPU_ID_VERSION_STATUS_SHIFT))
