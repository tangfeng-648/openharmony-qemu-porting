...
#ifndef KBASE_DEBUG_KTRACE_JM_H_
#define KBASE_DEBUG_KTRACE_JM_H_
 ...
 */
void kbasep_ktrace_add_jm(struct kbase_device *kbdev, enum kbase_ktrace_code code, struct kbase_context *kctx,
                          struct kbase_jd_atom *katom, u64 gpu_addr, kbase_ktrace_flag_t flags, int refcount,
                          int jobslot, u64 info_val);

#define KBASE_KTRACE_RBUF_ADD_JM(kbdev, code, kctx, katom, gpu_addr, flags, refcount, jobslot, info_val)               \
    kbasep_ktrace_add_jm(kbdev, KBASE_KTRACE_CODE(code), kctx, katom, gpu_addr, flags, refcount, jobslot, info_val)
...
#define KBASE_KTRACE_FTRACE_ADD_JM_SLOT(kbdev, code, kctx, katom, gpu_addr, jobslot) trace_mali_##code(kctx, jobslot, 0)

#define KBASE_KTRACE_FTRACE_ADD_JM_SLOT_INFO(kbdev, code, kctx, katom, gpu_addr, jobslot, info_val)                    \
...
#define KBASE_KTRACE_FTRACE_ADD_JM_REFCOUNT_INFO(kbdev, code, kctx, katom, gpu_addr, refcount, info_val)               \
...
#define KBASE_KTRACE_ADD_JM_SLOT(kbdev, code, kctx, katom, gpu_addr, jobslot)                                          \
    do {                                                                                                               \
        ...
        KBASE_KTRACE_RBUF_ADD_JM(kbdev, code, kctx, katom, __gpu_addr, KBASE_KTRACE_FLAG_JM_JOBSLOT, 0, __jobslot, 0); \
...
#define KBASE_KTRACE_ADD_JM_SLOT_INFO(kbdev, code, kctx, katom, gpu_addr, jobslot, info_val)                           \
    do {                                                                                                               \
        ...
        KBASE_KTRACE_RBUF_ADD_JM(kbdev, code, kctx, katom, __gpu_addr, KBASE_KTRACE_FLAG_JM_JOBSLOT, 0, __jobslot,     \
                                 __info_val);                                                                          \
...
#define KBASE_KTRACE_ADD_JM_REFCOUNT(kbdev, code, kctx, katom, gpu_addr, refcount)                                     \
    do {                                                                                                               \
        ...
        KBASE_KTRACE_RBUF_ADD_JM(kbdev, code, kctx, katom, __gpu_addr, KBASE_KTRACE_FLAG_JM_REFCOUNT, __refcount, 0,   \
                                 0u);                                                                                  \
...
#define KBASE_KTRACE_ADD_JM(kbdev, code, kctx, katom, gpu_addr, info_val)                                              \
    do {                                                                                                               \
        ...
        u64 __gpu_addr = gpu_addr;                                                                                     \
        u64 __info_val = info_val;                                                                                     \
        KBASE_KTRACE_RBUF_ADD_JM(kbdev, code, kctx, katom, __gpu_addr, 0u, 0, 0, __info_val);                          \
