...
#ifndef H_GPU_ARM_BIFROST_MALI_KBASE_HWCNT_VIRTUALIZER_H
#define H_GPU_ARM_BIFROST_MALI_KBASE_HWCNT_VIRTUALIZER_H
...
#endif /* H_GPU_ARM_BIFROST_MALI_KBASE_HWCNT_VIRTUALIZER_H */
