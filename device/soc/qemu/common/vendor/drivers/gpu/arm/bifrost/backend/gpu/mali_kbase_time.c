...
void kbase_backend_get_gpu_time_norequest(struct kbase_device *kbdev, u64 *cycle_counter, u64 *system_time,
                                          struct timespec64 *ts)
{
    ...
    if (cycle_counter) {
        ...
        do {
            ...
            *cycle_counter = kbase_reg_read(kbdev, GPU_CONTROL_REG(CYCLE_COUNT_LO));
    ...
    if (system_time) {
        ...
        do {
            ...
            *system_time = kbase_reg_read(kbdev, GPU_CONTROL_REG(TIMESTAMP_LO));
